...
func UserFileSearchHandler(svcCtx *svc.ServiceContext) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		l := logic.NewUserFileSearchLogic(c.Request.Context(), svcCtx)
		resp, err := l.UserFileSearch(&req, userIdentity)
		if err != nil {
			respondError(c, err)
			return
		}
